...
import ACTION_MORNING_MOISTURIZER_PRODUCT_FREQUENCY from "../../../../../../actions/MyRoutine/Morning/Moisturizer/ProductFrequency/ACTION_MORNING_MOISTURIZER_PRODUCT_FREQUENCY";
...
const MorningMoisturizer = React.forwardRef((props, ref) => {
  ...
  const morningMoisturizerProductFrequency = useSelector(
    (state) =>
      state.morningMoisturizerProductFrequency
        .morning_moisturizer_product_frequency
  );
  const morningMoisturizerProductLink = useSelector(
    (state) =>
      state.morningMoisturizerProductLink.morning_moisturizer_product_link
  );
  const morningMoisturizerProductName = useSelector(
    (state) =>
      state.morningMoisturizerProductName.morning_moisturizer_product_name
  );
  const morningMoisturizerProductUseNotes = useSelector(
    (state) =>
  ...
  const handleProductName = (e) => {
    dispatch(
      ACTION_MORNING_MOISTURIZER_PRODUCT_NAME(e.currentTarget.value.trim())
    );
  };

  const handleProductFrequency = (e) => {
    dispatch(
      ACTION_MORNING_MOISTURIZER_PRODUCT_FREQUENCY(e.currentTarget.value.trim())
    );
  };

  const handleProductUsageDetails = (e) => {
    dispatch(
      ACTION_MORNING_MOISTURIZER_PRODUCT_USE_NOTES(e.currentTarget.value.trim())
    );
  };

  const handleProductLink = (e) => {
    dispatch(
      ACTION_MORNING_MOISTURIZER_PRODUCT_LINK(e.currentTarget.value.trim())
    );
  };
...
export default MorningMoisturizer;
