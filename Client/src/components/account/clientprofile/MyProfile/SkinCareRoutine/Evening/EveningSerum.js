...
import ACTION_EVENING_SERUM_PRODUCT_NAME from "../../../../../../actions/MyRoutine/Evening/Serum/ProductName/ACTION_EVENING_SERUM_PRODUCT_NAME";
import ACTION_EVENING_SERUM_PRODUCT_FREQUENCY from "../../../../../../actions/MyRoutine/Evening/Serum/ProductFrequency/ACTION_EVENING_SERUM_PRODUCT_FREQUENCY";
import ACTION_EVENING_SERUM_PRODUCT_USE_NOTES from "../../../../../../actions/MyRoutine/Evening/Serum/ProductUseNotes/ACTION_EVENING_SERUM_PRODUCT_USE_NOTES";
import ACTION_EVENING_SERUM_PRODUCT_LINK from "../../../../../../actions/MyRoutine/Evening/Serum/ProductLink/ACTION_EVENING_SERUM_PRODUCT_LINK";
import ACTION_RESET_ALL_EVENING_SERUM_FIELDS from "../../../../../../actions/MyRoutine/Evening/Serum/ACTION_RESET_ALL_EVENING_SERUM_FIELDS";

const EveningSerum = React.forwardRef((props, ref) => {
  const dispatch = useDispatch();
  const eveningSerumProductFrequency = useSelector(
    (state) =>
      state.eveningSerumProductFrequency.evening_serum_product_frequency
  );
  const eveningSerumProductLink = useSelector(
    (state) => state.eveningSerumProductLink.evening_serum_product_link
  );
  const eveningSerumProductName = useSelector(
    (state) => state.eveningSerumProductName.evening_serum_product_name
  );
  const eveningSerumProductUseNotes = useSelector(
    (state) => state.eveningSerumProductUseNotes.evening_serum_product_use_notes
  );

  const handleProductName = (e) => {
    dispatch(ACTION_EVENING_SERUM_PRODUCT_NAME(e.currentTarget.value.trim()));
  };

  const handleProductFrequency = (e) => {
    dispatch(
      ACTION_EVENING_SERUM_PRODUCT_FREQUENCY(e.currentTarget.value.trim())
    );
  };

  const handleProductUsageDetails = (e) => {
    dispatch(
      ACTION_EVENING_SERUM_PRODUCT_USE_NOTES(e.currentTarget.value.trim())
    );
  };

  const handleProductLink = (e) => {
    dispatch(ACTION_EVENING_SERUM_PRODUCT_LINK(e.currentTarget.value.trim()));
  };
  ...
  return (
    <div
      ...
      onClick={(e) => props.handleItemToggled(e, "evening_serum")}
              ...
              {props.addProductClicked ? (
                  ...
                  <Form className="add_product_form">
                    <FormGroup className="add_product_form_field">
                      ...
                      <Input
                        ...
                        defaultValue={eveningSerumProductName}
                    ...
                    <FormGroup className="add_product_form_field">
                      ...
                      <Input
                        ...
                        className="input_field_product"
                        defaultValue={eveningSerumProductFrequency}
                    ...
                    <FormGroup className="add_product_form_field">
                      ...
                      <Input
                        ...
                        maxLength={1000}
                        defaultValue={eveningSerumProductUseNotes}
                    ...
                    <FormGroup className="add_product_form_field">
                      ...
                      <Input
                        ...
                        className="input_field_product"
                        defaultValue={eveningSerumProductLink}
                ...
                <div className="my_individual_selected_item_empty_state_container">
                  ...
                  <div className="my_individual_selected_item_empty_state_text_container">
                    <h2>No afternoon / evening serum information</h2>
                    <p>
