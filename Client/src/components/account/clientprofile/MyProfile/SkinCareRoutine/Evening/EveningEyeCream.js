...
import ACTION_EVENING_EYE_CREAM_PRODUCT_NAME from "../../../../../../actions/MyRoutine/Evening/EyeCream/ProductName/ACTION_EVENING_EYE_CREAM_PRODUCT_NAME";
import ACTION_EVENING_EYE_CREAM_PRODUCT_FREQUENCY from "../../../../../../actions/MyRoutine/Evening/EyeCream/ProductFrequency/ACTION_EVENING_EYE_CREAM_PRODUCT_FREQUENCY";
import ACTION_EVENING_EYE_CREAM_PRODUCT_USE_NOTES from "../../../../../../actions/MyRoutine/Evening/EyeCream/ProductUseNotes/ACTION_EVENING_EYE_CREAM_PRODUCT_USE_NOTES";
import ACTION_EVENING_EYE_CREAM_PRODUCT_LINK from "../../../../../../actions/MyRoutine/Evening/EyeCream/ProductLink/ACTION_EVENING_EYE_CREAM_PRODUCT_LINK";
import ACTION_RESET_ALL_EVENING_EYE_CREAM_FIELDS from "../../../../../../actions/MyRoutine/Evening/EyeCream/ACTION_RESET_ALL_EVENING_EYE_CREAM_FIELDS";

const EveningEyeCream = React.forwardRef((props, ref) => {
  const dispatch = useDispatch();
  const eveningEyeCreamProductFrequency = useSelector(
    (state) =>
      state.eveningEyeCreamProductFrequency.evening_eye_cream_product_frequency
  );
  const eveningEyeCreamProductLink = useSelector(
    (state) => state.eveningEyeCreamProductLink.evening_eye_cream_product_link
  );
  const eveningEyeCreamProductName = useSelector(
    (state) => state.eveningEyeCreamProductName.evening_eye_cream_product_name
  );
  const eveningEyeCreamProductUseNotes = useSelector(
    (state) =>
      state.eveningEyeCreamProductUseNotes.evening_eye_cream_product_use_notes
  );

  const handleProductName = (e) => {
    dispatch(
      ACTION_EVENING_EYE_CREAM_PRODUCT_NAME(e.currentTarget.value.trim())
    );
  };

  const handleProductFrequency = (e) => {
    dispatch(
      ACTION_EVENING_EYE_CREAM_PRODUCT_FREQUENCY(e.currentTarget.value.trim())
    );
  };

  const handleProductUsageDetails = (e) => {
    dispatch(
      ACTION_EVENING_EYE_CREAM_PRODUCT_USE_NOTES(e.currentTarget.value.trim())
    );
  };

  const handleProductLink = (e) => {
    dispatch(
      ACTION_EVENING_EYE_CREAM_PRODUCT_LINK(e.currentTarget.value.trim())
    );
  };

  useEffect(() => {
    return () => {
      dispatch(ACTION_RESET_ALL_EVENING_EYE_CREAM_FIELDS());
    };
  }, [dispatch]);
  ...
  return (
    <div
      ...
      onClick={(e) => props.handleItemToggled(e, "evening_eye_cream")}
              ...
              {props.addProductClicked ? (
                  ...
                  <Form className="add_product_form">
                    <FormGroup className="add_product_form_field">
                      ...
                      <Input
                        ...
                        defaultValue={eveningEyeCreamProductName}
                    ...
                    <FormGroup className="add_product_form_field">
                      ...
                      <Input
                        ...
                        className="input_field_product"
                        defaultValue={eveningEyeCreamProductFrequency}
                    ...
                    <FormGroup className="add_product_form_field">
                      ...
                      <Input
                        ...
                        maxLength={1000}
                        defaultValue={eveningEyeCreamProductUseNotes}
                    ...
                    <FormGroup className="add_product_form_field">
                      ...
                      <Input
                        ...
                        className="input_field_product"
                        defaultValue={eveningEyeCreamProductLink}
                ...
                <div className="my_individual_selected_item_empty_state_container">
                  ...
                  <div className="my_individual_selected_item_empty_state_text_container">
                    <h2>No afternoon / evening eye cream information</h2>
                    <p>
...
export default EveningEyeCream;
