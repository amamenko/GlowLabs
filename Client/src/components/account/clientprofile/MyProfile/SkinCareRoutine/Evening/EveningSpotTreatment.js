...
import ACTION_SPOT_TREATMENT_PRODUCT_NAME from "../../../../../../actions/MyRoutine/Evening/SpotTreatment/ProductName/ACTION_SPOT_TREATMENT_PRODUCT_NAME";
import ACTION_SPOT_TREATMENT_PRODUCT_FREQUENCY from "../../../../../../actions/MyRoutine/Evening/SpotTreatment/ProductFrequency/ACTION_SPOT_TREATMENT_PRODUCT_FREQUENCY";
import ACTION_SPOT_TREATMENT_PRODUCT_USE_NOTES from "../../../../../../actions/MyRoutine/Evening/SpotTreatment/ProductUseNotes/ACTION_SPOT_TREATMENT_PRODUCT_USE_NOTES";
import ACTION_SPOT_TREATMENT_PRODUCT_LINK from "../../../../../../actions/MyRoutine/Evening/SpotTreatment/ProductLink/ACTION_SPOT_TREATMENT_PRODUCT_LINK";
...
const EveningSpotTreatment = React.forwardRef((props, ref) => {
  const dispatch = useDispatch();
  const spotTreatmentProductFrequency = useSelector(
    (state) =>
      state.spotTreatmentProductFrequency.spot_treatment_product_frequency
  );
  const spotTreatmentProductLink = useSelector(
    (state) => state.spotTreatmentProductLink.spot_treatment_product_link
  );
  const spotTreatmentProductName = useSelector(
    (state) => state.spotTreatmentProductName.spot_treatment_product_name
  );
  const spotTreatmentProductUseNotes = useSelector(
    (state) =>
      state.spotTreatmentProductUseNotes.spot_treatment_product_use_notes
  );

  const handleProductName = (e) => {
    dispatch(ACTION_SPOT_TREATMENT_PRODUCT_NAME(e.currentTarget.value.trim()));
  };

  const handleProductFrequency = (e) => {
    dispatch(
      ACTION_SPOT_TREATMENT_PRODUCT_FREQUENCY(e.currentTarget.value.trim())
    );
  };

  const handleProductUsageDetails = (e) => {
    dispatch(
      ACTION_SPOT_TREATMENT_PRODUCT_USE_NOTES(e.currentTarget.value.trim())
    );
  };

  const handleProductLink = (e) => {
    dispatch(ACTION_SPOT_TREATMENT_PRODUCT_LINK(e.currentTarget.value.trim()));
  };
  ...
  return (
    <div
      ...
      onClick={(e) => props.handleItemToggled(e, "evening_spot_treatment")}
                  ...
                  <Form className="add_product_form">
                    <FormGroup className="add_product_form_field">
                      ...
                      <Input
                        ...
                        defaultValue={spotTreatmentProductName}
                    ...
                    <FormGroup className="add_product_form_field">
                      ...
                      <Input
                        ...
                        className="input_field_product"
                        defaultValue={spotTreatmentProductFrequency}
                    ...
                    <FormGroup className="add_product_form_field">
                      ...
                      <Input
                        ...
                        maxLength={1000}
                        defaultValue={spotTreatmentProductUseNotes}
                    ...
                    <FormGroup className="add_product_form_field">
                      ...
                      <Input
                        ...
                        className="input_field_product"
                        defaultValue={spotTreatmentProductLink}
...
export default EveningSpotTreatment;
