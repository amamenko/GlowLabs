...
import ACTION_EVENING_RX_PRODUCT_NAME from "../../../../../../actions/MyRoutine/Evening/RX/ProductName/ACTION_EVENING_RX_PRODUCT_NAME";
import ACTION_EVENING_RX_PRODUCT_FREQUENCY from "../../../../../../actions/MyRoutine/Evening/RX/ProductFrequency/ACTION_EVENING_RX_PRODUCT_FREQUENCY";
import ACTION_EVENING_RX_PRODUCT_USE_NOTES from "../../../../../../actions/MyRoutine/Evening/RX/ProductUseNotes/ACTION_EVENING_RX_PRODUCT_USE_NOTES";
import ACTION_EVENING_RX_PRODUCT_LINK from "../../../../../../actions/MyRoutine/Evening/RX/ProductLink/ACTION_EVENING_RX_PRODUCT_LINK";
import ACTION_RESET_ALL_EVENING_RX_FIELDS from "../../../../../../actions/MyRoutine/Evening/RX/ACTION_RESET_ALL_EVENING_RX_FIELDS";

const EveningRX = React.forwardRef((props, ref) => {
  const dispatch = useDispatch();
  const eveningRXProductFrequency = useSelector(
    (state) => state.eveningRXProductFrequency.evening_rx_product_frequency
  );
  const eveningRXProductLink = useSelector(
    (state) => state.eveningRXProductLink.evening_rx_product_link
  );
  const eveningRXProductName = useSelector(
    (state) => state.eveningRXProductName.evening_rx_product_name
  );
  const eveningRXProductUseNotes = useSelector(
    (state) => state.eveningRXProductUseNotes.evening_rx_product_use_notes
  );

  const handleProductName = (e) => {
    dispatch(ACTION_EVENING_RX_PRODUCT_NAME(e.currentTarget.value.trim()));
  };

  const handleProductFrequency = (e) => {
    dispatch(ACTION_EVENING_RX_PRODUCT_FREQUENCY(e.currentTarget.value.trim()));
  };

  const handleProductUsageDetails = (e) => {
    dispatch(ACTION_EVENING_RX_PRODUCT_USE_NOTES(e.currentTarget.value.trim()));
  };

  const handleProductLink = (e) => {
    dispatch(ACTION_EVENING_RX_PRODUCT_LINK(e.currentTarget.value.trim()));
  };

  useEffect(() => {
    return () => {
      dispatch(ACTION_RESET_ALL_EVENING_RX_FIELDS());
    };
  }, [dispatch]);
  ...
  return (
    <div
      ...
      onClick={(e) => props.handleItemToggled(e, "evening_prescriptions")}
    ...
    >
      ...
      >
        {(itemToggled) =>
          itemToggled === "evening_prescriptions" &&
          ((styleprops) => (
            <div
              ...
              {props.addProductClicked ? (
                  ...
                  <Form className="add_product_form">
                    <FormGroup className="add_product_form_field">
                      ...
                      <Input
                        ...
                        defaultValue={eveningRXProductName}
                    ...
                    <FormGroup className="add_product_form_field">
                      ...
                      <Input
                        ...
                        className="input_field_product"
                        defaultValue={eveningRXProductFrequency}
                    ...
                    <FormGroup className="add_product_form_field">
                      ...
                      <Input
                        ...
                        maxLength={1000}
                        defaultValue={eveningRXProductUseNotes}
                    ...
                    <FormGroup className="add_product_form_field">
                      ...
                      <Input
                        ...
                        className="input_field_product"
                        defaultValue={eveningRXProductLink}
                ...
                <div className="my_individual_selected_item_empty_state_container">
                  ...
                  <div className="my_individual_selected_item_empty_state_text_container">
                    <h2>
                      No evening prescription creams & medications information
                    </h2>
                    <p>
