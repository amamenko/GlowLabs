  ...
  return (
    <div className="microneedle_wrapping" ref={ref}>
      {inView ? (
        ...
        >
          {props => (
            <section className="microneedle_card" style={props}>
              <div className="microneedle_card_image">
                <Spring
                ...
                <div className="microneedle_border_right" />
              </div>
              <div className="microneedle_description">
                <div className="microneedle_description_inner_wrapper">
                  <h2 style={{ fontWeight: 400 }}>MICRONEEDLE INFUSION</h2>
                  <p
                    className="microneedle_description_subheader"
                    style={{ opacity: 0.6 }}
                  >
                    Repairing
                  </p>
                  <p
                    className="microneedle_description_paragraph"
                    style={{ fontSize: "0.8rem", lineHeight: "20px" }}
                  >
                    Collagen production is stimulated via LED and hydrating mask
                    to treat scarring and stretch marks.
                  </p>
                  <div className="microneedle_card_bottom_wrapper">
                    <p>LEARN MORE</p>
                    <span className="microneedle_card_bottom_spacer" />
                    <FontAwesomeIcon
                      className="microneedle_suitcase_icon"
                      icon={faSuitcase}
                    />
                  </div>
                </div>
