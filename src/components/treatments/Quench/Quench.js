...
const Quench = () => (
  <section className="quench_card">
    <div className="quench_card_image">
      <Spring from={{ x: 210 }} to={{ x: 0 }} config={{ duration: 1000 }}>
        {props => (
          <svg
    ...
    <div className="quench_description">
      ...
      <p className="quench_description_subheader" style={{ opacity: 0.5 }}>
        Hydrating
      </p>
      <p style={{ fontSize: "0.8rem" }}>
        Make your skin look dewy, glowing and healthy. Quench brings water
        content back into your skin and locks that moisture in. This facial is
        ideal for those with dehydrated, dry and irritated skin.
      </p>
      <p className="quench_card_toggler">
        LEARN MORE
        <span className="quench_card_bottom_spacer" />
        <FontAwesomeIcon className="quench_suitcase_icon" icon={faSuitcase} />
      </p>
    </div>
  </section>
);
