  ...
  return (
    <div className="chemical_peel_wrapping" ref={ref}>
      {inView ? (
        ...
        >
          {props => (
            <section className="chemical_peel_card" style={props}>
              <div className="chemical_peel_card_image">
                ...
                <div className="chemical_peel_border_right" />
              </div>
              <div className="chemical_peel_description">
                <div className="chemical_peel_description_inner_wrapper">
                  ...
                  <p
                    className="chemical_peel_description_paragraph"
                    style={{ fontSize: "0.8rem", lineHeight: "20px" }}
                  >
                    Chemical peels exfoliate and smoothen the texture of skin.
                    They also minimize sun damage and pigmentation from acne
                    scarring.
                  </p>
                  <div className="chemical_peel_card_bottom_wrapper">
                    <p>LEARN MORE</p>
