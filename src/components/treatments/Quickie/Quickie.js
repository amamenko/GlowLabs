...
const Quickie = () => (
  <section className="quickie_card">
    <div className="quickie_card_image">
      <Spring from={{ x: 200 }} to={{ x: 0 }} config={{ duration: 1500 }}>
        {props => (
          <svg
            className="quickie_svg"
            width="100%"
            height="15rem"
    ...
    <div className="quickie_description">
      <h2 style={{ fontWeight: 400 }}>quickie</h2>
      <p className="quickie_description_subheader" style={{ opacity: 0.5 }}>
        Speedy Results
      </p>
      <p style={{ fontSize: "0.8rem" }}>
        Quickie is an all encompassing, fast, focused treatment meant to give
        you a boost for a night out or big event. Quickie will leave you with a
        nice glow in a shorter time – and for a lower cost. Mini facials give
        you tighter, smoother, healthier skin, and can even help with acne. Even
        just a short session can help to correct small imperfections in the
        outermost layers of the skin, such as sun damage or thin, fine lines.
      </p>
      <p className="quickie_card_toggler">
        LEARN MORE
        <span className="quickie_card_bottom_spacer" />
        <FontAwesomeIcon className="quickie_suitcase_icon" icon={faSuitcase} />
      </p>
    </div>
  </section>
);
