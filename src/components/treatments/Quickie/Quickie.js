  ...
  return (
    <div className="quickie_wrapping" ref={ref}>
      {inView ? (
        ...
        >
          {props => (
            <section className="quickie_card" style={props}>
              <div className="quickie_card_image">
                ...
                <div className="quickie_border_right" />
              </div>
              <div className="quickie_description">
                <div className="quench_description_inner_wrapper">
                  <h2 style={{ fontWeight: 400 }}>QUICKIE</h2>
                  <p
                    className="quickie_description_subheader"
                    style={{ opacity: 0.6 }}
                  >
                    Speedy Results
                  </p>
                  <p
                    className="quickie_description_paragraph"
                    style={{ fontSize: "0.8rem", lineHeight: "20px" }}
                  >
                    Quickie is an all-encompassing, fast, focused treatment
                    meant to give you a boost for a night out or big event.
                  </p>
                  <div className="quickie_card_bottom_wrapper">
                    <p>LEARN MORE</p>
                    <span className="quickie_card_bottom_spacer" />
                    <FontAwesomeIcon
                      className="quickie_suitcase_icon"
                      icon={faSuitcase}
                    />
                  </div>
                </div>
