  ...
  return (
    <div className="notification_removed_container">
      ...
      <div className="notification_text_container">
        <h3>Dermaplaning Removed</h3>
        <p>The Dermaplaning facial treatment has been removed from your cart</p>
      </div>
    </div>
  );
};
