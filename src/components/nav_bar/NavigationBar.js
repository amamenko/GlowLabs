      ...
      if (props.initialScreenSize >= 600) {
        if (props.navbarToggle) {
          ...
          if (props.scroll) {
            ...
            return "linear-gradient(to right, rgb(251, 251, 251) 0%, rgb(251, 251, 251) 50%, rgb(194, 194, 202) 50.05%, rgb(194, 194, 202) 100%)";
          }
        }
      } else {
        return "rgb(44,44,52)";
